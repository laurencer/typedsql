...
"""
  ...
  def basic = {
    ...
    val customers       = createDataSource(ThriftStructType[Customer])(
    ...
    val orderLineItems  = createDataSource[OrderLineItem](ThriftStructType[OrderLineItem])()
    val payments        = createDataSource[Payment](ThriftStructType[Payment])()
